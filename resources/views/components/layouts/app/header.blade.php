    ...
    <body class="min-h-screen bg-white light-mode">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50">
            ...
            <flux:navbar class="-mb-px max-lg:hidden">
                ...
                <flux:navbar.item icon="table" :href="route('student.dataset')" :current="request()->routeIs('student.dataset')" wire:navigate>
                    {{ __('Dataset Siswa') }}
                </flux:navbar.item>
            </flux:navbar>
        ...
        <flux:sidebar stashable sticky class="lg:hidden border-r border-zinc-200 bg-zinc-50">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')">
                    ...
                    <flux:navlist.item icon="table" :href="route('student.dataset')" :current="request()->routeIs('student.dataset')" wire:navigate>
                    {{ __('Dataset Siswa') }}
                    </flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
