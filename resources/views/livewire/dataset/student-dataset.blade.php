                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-blue-700">
                                        <strong>Petunjuk:</strong> Untuk hasil terbaik, gunakan format CSV. Meskipun Excel (.xlsx, .xls) juga didukung, server saat ini memiliki keterbatasan dalam memproses file Excel.
                                    </p>
                                    <p class="text-sm text-blue-700 mt-1">
                                        <strong>Cara konversi Excel ke CSV:</strong> Buka file Excel → Klik menu File → Pilih Save As/Simpan Sebagai → Pilih format CSV → Klik Simpan
                                    </p>
                                </div>
                            </div>
                        </div>
